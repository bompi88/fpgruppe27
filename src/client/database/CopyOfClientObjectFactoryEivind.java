 ...
 */
public class CopyOfClientObjectFactoryEivind {
...
//		}
		...
		CopyOfClientObjectFactoryEivind.addMeeting(new Meeting(0, "kaffe", new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), new Room(), "ntnu",
...
//				new Employee("andybb2", "abc123"), test, false, "testnavvvn"));
	...
	public CopyOfClientObjectFactoryEivind() {
		httpClient = HttpClientBuilder.create().build();
	}
	
	
	//Start forandringer gjort av meg. 
	/**
	...
	public static void setMessageAsSeen(Message message){
		...
		putRequest(put, null); // usikker om er riktig. 
		EntityUtils.consumeQuietly(response.getEntity());
		
	}
	
	// slutt forandringer gjort av meg. 
