...
//	protected String userHasDeclinedMessage = "Har medlt avbud til" + meeting.getMeetingName();
	...
	public Message(MeetingModel meetingModel, String type, ParticipantModel messageOwner, ParticipantModel userInQestion) throws ClassNotFoundException, SQLException{
