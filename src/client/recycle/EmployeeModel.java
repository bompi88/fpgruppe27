...
public class EmployeeModel{
	...
	public EmployeeModel(String name, String username, String email, String password) {
		super();
		this.name = name;
...
//	} 
//	
//	public void updateInbox() throws ClassNotFoundException, SQLException{ // kjører kontinuerlig. Henter TimeStamp fra siste melding, og ser etter nye meldinger ��������� lage objekter av, 
